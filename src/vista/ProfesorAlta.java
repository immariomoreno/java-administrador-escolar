...
public class ProfesorAlta extends javax.swing.JFrame {
    ...
    public void validaCampoTexto2(){
        if(!objValidador.validarCajaTextoEntero(jTextField1)) return;
        if(! objValidador.validarCajaTextoCadena(jTextField2)) return;
        //aquí empiezan los que hice yo
        if(! objValidador.validarCajaTextoCadena(jTextField3)) return;
